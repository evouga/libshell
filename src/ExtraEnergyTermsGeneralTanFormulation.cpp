...
double ExtraEnergyTermsGeneralTanFormulation::compute_magnitude_compression_energy_perface(const Eigen::VectorXd& edge_dofs,
...
double ExtraEnergyTermsGeneralTanFormulation::compute_magnitude_compression_energy(const Eigen::VectorXd& edge_dofs,
                                                              const MeshConnectivity& mesh,
                                                              Eigen::VectorXd* deriv,
...
double ExtraEnergyTermsGeneralTanFormulation::compute_vector_perp_tangent_energy_perface(const Eigen::MatrixXd& cur_pos,
...
double ExtraEnergyTermsGeneralTanFormulation::compute_vector_perp_tangent_energy(const Eigen::MatrixXd& cur_pos,
                                                            const Eigen::VectorXd& edge_dofs,
                                                            const MeshConnectivity& mesh,
                                                            const std::vector<Eigen::Matrix2d> &abars,
                                                            Eigen::VectorXd* deriv,
    ...
    constexpr int nedgedofs = MidedgeAngleGeneralTanFormulation::numExtraDOFs;
...
double ExtraEnergyTermsGeneralTanFormulation::compute_magnitude_sq_change_energy_perface(const Eigen::VectorXd& edge_dofs,
                                                                    const MeshConnectivity& mesh,
                                                                    const std::vector<Eigen::Matrix2d>& abars,
                                                                    int face,
                                                                    Eigen::VectorXd* deriv,
...
double ExtraEnergyTermsGeneralTanFormulation::compute_magnitude_sq_change_energy(const Eigen::VectorXd& edge_dofs,
                                                            const MeshConnectivity& mesh,
                                                            const std::vector<Eigen::Matrix2d>& abars,
                                                            Eigen::VectorXd* deriv,
                                                            std::vector<Eigen::Triplet<double>>* hessian,
...
void ExtraEnergyTermsGeneralTanFormulation::test_compute_magnitude_compression_energy_perface(const MeshConnectivity& mesh,
                                                                         const Eigen::VectorXd& edge_dofs,
                                                                         int face)  {
}

void ExtraEnergyTermsGeneralTanFormulation::test_compute_magnitude_compression_energy(const MeshConnectivity& mesh,
                                                                 const Eigen::VectorXd& edge_dofs)  {
}

void ExtraEnergyTermsGeneralTanFormulation::test_compute_vector_perp_tangent_energy_perface(const MeshConnectivity& mesh,
const std::vector<Eigen::Matrix2d>& abars,
                                                                       const Eigen::MatrixXd& cur_pos,
                                                                       const Eigen::VectorXd& edge_dofs,
                                                                       int face)  {
    static constexpr int numExtraDOFs = MidedgeAngleGeneralTanFormulation::numExtraDOFs;
...
void ExtraEnergyTermsGeneralTanFormulation::test_compute_vector_perp_tangent_energy(const MeshConnectivity& mesh,
                                                               const std::vector<Eigen::Matrix2d>& abars,
                                                               const Eigen::MatrixXd& cur_pos,
                                                               const Eigen::VectorXd& edge_dofs)  {
    int nedges = mesh.nEdges();
...
void ExtraEnergyTermsGeneralTanFormulation::test_compute_magnitude_sq_change_energy_perface(const MeshConnectivity& mesh,
                                                                       const std::vector<Eigen::Matrix2d>& abars,
                                                                         const Eigen::VectorXd& edge_dofs,
                                                                         int face)  {
}

void ExtraEnergyTermsGeneralTanFormulation::test_compute_magnitude_sq_change_energy(const MeshConnectivity& mesh,
                                                               const std::vector<Eigen::Matrix2d>& abars,
                                                                 const Eigen::VectorXd& edge_dofs)  {
}

...
double ExtraEnergyTermsSinFormulation::compute_magnitude_compression_energy_perface(const Eigen::VectorXd& edge_dofs,
...
double ExtraEnergyTermsSinFormulation::compute_magnitude_compression_energy(const Eigen::VectorXd& edge_dofs,
                                                              const MeshConnectivity& mesh,
                                                              Eigen::VectorXd* deriv,
...
double ExtraEnergyTermsSinFormulation::compute_vector_perp_tangent_energy_perface(const Eigen::MatrixXd& cur_pos,
...
double ExtraEnergyTermsSinFormulation::compute_vector_perp_tangent_energy(const Eigen::MatrixXd& cur_pos,
                                                            const Eigen::VectorXd& edge_dofs,
                                                            const MeshConnectivity& mesh,
                                                            const std::vector<Eigen::Matrix2d> &abars,
                                                            Eigen::VectorXd* deriv,
    ...
    const int nedgedofs_extended = MidedgeAngleGeneralSinFormulation::numExtraDOFs;
...
double ExtraEnergyTermsSinFormulation::compute_magnitude_sq_change_energy_perface(const Eigen::VectorXd& edge_dofs,
                                                                    const MeshConnectivity& mesh,
                                                                    const std::vector<Eigen::Matrix2d>& abars,
                                                                    int face,
                                                                    Eigen::VectorXd* deriv,
...
double ExtraEnergyTermsSinFormulation::compute_magnitude_sq_change_energy(const Eigen::VectorXd& edge_dofs,
                                                            const MeshConnectivity& mesh,
                                                            const std::vector<Eigen::Matrix2d>& abars,
                                                            Eigen::VectorXd* deriv,
                                                            std::vector<Eigen::Triplet<double>>* hessian,
...
void ExtraEnergyTermsSinFormulation::test_compute_magnitude_compression_energy_perface(const MeshConnectivity& mesh,
                                                                         const Eigen::VectorXd& edge_dofs,
                                                                         int face)  {
}

void ExtraEnergyTermsSinFormulation::test_compute_magnitude_compression_energy(const MeshConnectivity& mesh,
                                                                 const Eigen::VectorXd& edge_dofs)  {
}

void ExtraEnergyTermsSinFormulation::test_compute_vector_perp_tangent_energy_perface(const MeshConnectivity& mesh,
const std::vector<Eigen::Matrix2d>& abars,
                                                                       const Eigen::MatrixXd& cur_pos,
                                                                       const Eigen::VectorXd& edge_dofs,
                                                                       int face)  {
    const int numExtraDOFs = MidedgeAngleGeneralSinFormulation::numExtraDOFs;
...
void ExtraEnergyTermsSinFormulation::test_compute_vector_perp_tangent_energy(const MeshConnectivity& mesh,
                                                               const std::vector<Eigen::Matrix2d>& abars,
                                                               const Eigen::MatrixXd& cur_pos,
                                                               const Eigen::VectorXd& edge_dofs)  {
    int nedges = mesh.nEdges();
...
void ExtraEnergyTermsSinFormulation::test_compute_magnitude_sq_change_energy_perface(const MeshConnectivity& mesh,
                                                                       const std::vector<Eigen::Matrix2d>& abars,
                                                                         const Eigen::VectorXd& edge_dofs,
                                                                         int face)  {
}

void ExtraEnergyTermsSinFormulation::test_compute_magnitude_sq_change_energy(const MeshConnectivity& mesh,
                                                               const std::vector<Eigen::Matrix2d>& abars,
                                                                 const Eigen::VectorXd& edge_dofs)  {
}

double ExtraEnergyTermsSinFormulation::compute_thirdFundamentalForm_energy(
    const Eigen::MatrixXd& cur_pos,
    const Eigen::VectorXd& edge_dofs,
    const MeshConnectivity& mesh,
    const std::vector<Eigen::Matrix2d>& abars,
...
double ExtraEnergyTermsSinFormulation::compute_thirdFundamentalForm_energy_perface(
    const Eigen::MatrixXd& cur_pos,
    const Eigen::VectorXd& edge_dofs,
    const MeshConnectivity& mesh,
    const std::vector<Eigen::Matrix2d>& abars,
...
void ExtraEnergyTermsSinFormulation::test_compute_thirdFundamentalForm_energy_perface(
    const MeshConnectivity& mesh,
    const std::vector<Eigen::Matrix2d>& abars,
    const Eigen::MatrixXd& cur_pos,
    const Eigen::VectorXd& edge_dofs,
...
void ExtraEnergyTermsSinFormulation::test_compute_thirdFundamentalForm_energy(
    const MeshConnectivity& mesh,
    const std::vector<Eigen::Matrix2d>& abars,
    const Eigen::MatrixXd& cur_pos,
    const Eigen::VectorXd& edge_dofs) {}
